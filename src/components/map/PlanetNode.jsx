...
const PLANET_QUESTS = {
  lumi:              ['Казка власноруч', 'Арт-портрет персонажа', 'Творча майстерня'],
  marik:             ['Крижинкова пригода', 'Чарівні кольори', 'Що всередині планети?'],
  orbita:            ['Звуковий орнамент', 'Букви-мандрівники', 'Перше слово'],
  zorx:              ['Цифрові сузір\'я', 'Хто більший?', 'Логічна послідовність'],
  'home-station':    ['Поради для батьків', 'Тижневий план', 'Запитання та відповіді'],
  'learning-center': ['Вебінар: Розвиток мовлення', 'Сертифікат логопеда', 'Онлайн-курс'],
  cosmodrome:        ['ПДШ Преміум', 'Школа майбутнього', 'Комплект матеріалів'],
}
